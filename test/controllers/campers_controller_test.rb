...
class CampersControllerTest < ActionController::TestCase
  ...
  test "should create camper" do
    assert_difference('Camper.count') do
      post :create, camper: { customer_id: @camper.customer_id, make_id: @camper.make_id, mileage: @camper.mileage, model: @camper.model, vin: @camper.vin, year: @camper.year }
    end
  ...
  test "should update camper" do
    patch :update, id: @camper, camper: { customer_id: @camper.customer_id, make_id: @camper.make_id, mileage: @camper.mileage, model: @camper.model, vin: @camper.vin, year: @camper.year }
    assert_redirected_to camper_path(assigns(:camper))
  end
